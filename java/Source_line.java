...
class Source_line{
	...
	public void evaluate_total_line_count(String word, int word_numb, int total_line_count){
		...
		switch (total_line_count) {
			case 1: this.label = word;break;
			case 2: tot_2_evaluate_word_numb(word, word_numb);break;
			case 3: tot_3_evaluate_word_numb(word, word_numb);break;
		}
	}
	public void tot_2_evaluate_word_numb(String word, int word_numb){
		switch (word_numb) {
			case 0: this.mnemonic = word;break;
			case 1: this.symbol = word;break;
		}
	}
	public void tot_3_evaluate_word_numb(String word, int word_numb){
		switch (word_numb) {
			case 0: this.label = word;break;
			case 1: this.mnemonic = word;break;
